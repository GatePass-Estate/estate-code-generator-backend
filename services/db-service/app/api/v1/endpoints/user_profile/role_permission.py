...
from app.schemas.user_profile.role_permission import (
    UserRole,
    CreateRequest,
    CreateResponse,
    DeleteResponse,
...
from app.services.user_profile.role_permission import (
    RolePermissionService as Service,
)
...
async def search(
    role_name: UserRole | None = None,
    can_register_estates: bool = None,
    can_register_admin: bool = None,
    can_register_users: bool = None,
    can_set_household_limits: bool = None,
    can_generate_code: bool = None,
    can_validate_code: bool = None,
