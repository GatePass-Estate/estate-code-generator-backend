...
from app.services.revenue.ai_marketplace_feature import (
    AiMarketplaceFeatureService as Service,
)
...
def get_service(
    ...
    """Build an AiMarketplaceFeatureService for the current request."""
...
async def update(
    ...
    """Update a marketplace feature by id."""
    try:
...
async def search(
    ...
    """Search marketplace features by name, category, and active flag."""
    try:
