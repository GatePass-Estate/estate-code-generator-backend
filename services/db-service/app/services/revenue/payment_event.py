...
from app.repositories.revenue.payment_event import (
    PaymentEventRepository as Repository,
)
from app.schemas.revenue.payment_event import (
    CreateRequest,
    CreateResponse,
    DeleteResponse,
    GetResponse,
...
class PaymentEventService:
    """
    Service class for payment_event table.
    """
