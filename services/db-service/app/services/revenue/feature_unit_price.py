...
from app.repositories.revenue.feature_unit_price import (
    FeatureUnitPriceRepository as Repository,
)
from app.schemas.revenue.feature_unit_price import (
    CreateRequest,
    CreateResponse,
    DeleteResponse,
    GetResponse,
...
class FeatureUnitPriceService:
    """
    Service class for feature_unit_price table.
    """
