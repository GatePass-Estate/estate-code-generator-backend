...
from app.repositories.revenue.service_catalog import (
    ServiceCatalogRepository as Repository,
)
from app.schemas.revenue.service_catalog import (
    CreateRequest,
    CreateResponse,
    DeleteResponse,
    GetResponse,
...
class ServiceCatalogService:
    """
    Service class for service_catalog table.
    """
