...
from app.repositories.revenue.estate_ai_feature import (
    EstateAiFeatureRepository as Repository,
)
...
class EstateAiFeatureService:
    """
    Service class for estate_ai_feature table.
    """
