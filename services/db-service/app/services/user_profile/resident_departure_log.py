...
from app.repositories.user_profile.resident_departure_log import (
    ResidentDepartureLogRepository as Repository,
)
from app.schemas.user_profile.estates import (
    CreateRequest,
    CreateResponse,
    DeleteResponse,
    GetResponse,
...
class ResidentDepartureLogService:
    """
    Service class for Resident Departure Log table.
