...
from app.repositories.user_profile.totp_recovery_codes import (
    TotpRecoveryCodesRepository as Repository,
)
...
class TotpRecoveryCodesService:
    """
    Service class for TotpRecoveryCodes table.
