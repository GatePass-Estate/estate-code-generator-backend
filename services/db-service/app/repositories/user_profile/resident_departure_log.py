...
from app.models import ResidentDepartureLog as TableModel
from app.schemas.user_profile.resident_departure_log import (
    CreateRequest,
    CreateResponse,
    DeleteResponse,
    GetResponse,
...
class ResidentDepartureLogRepository:
    """
    Repository to operate on resident departure log table.
    """
